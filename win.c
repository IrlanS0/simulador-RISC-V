...
int main(int argc, char *argv[]) {
        ...
        switch(opcode){
            ...
            case 0b1100011:{
                ...
                //bne
                    ...
                    //     x[5] = x[6];
                    //     printf("Forcando valores na serem iguais---t0=0x%08x--------t1=0x%08x", x[5], x[6]);
 ...
 // tipo U
            case 0b0010111:{
                ...
                // ### CORREÇÃO ###
                // Pegue os 20 bits superiores e zere os 12 inferiores
                // O (int32_t) fará a extensão de sinal corretamente
